...
export default function Sidebar({ 
  ...
  const menuItems = [
    ...
    { id: 'sandbox', label: 'Live CV Engine', icon: Camera },
    { id: 'library', label: 'Gesture Library', icon: FolderGit2 },
    { id: 'calibration', label: 'Calibration', icon: Sliders },
    { id: 'profiles', label: 'Settings', icon: Settings },
  ];

  return (
    <aside className="w-64 bg-[#0c0e12] border-r border-slate-800/40 flex flex-col justify-between select-none">
      {/* Brand Header */}
